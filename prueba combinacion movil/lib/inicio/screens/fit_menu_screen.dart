...
class FitMenuScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final cartCount = context.watch<CartModel>().count; // Escuchamos el contador
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Row(
          children: [
            Icon(Icons.fitness_center, color: AppColors.greenColor, size: 20),
            SizedBox(width: 8),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const Text('MENÚ SALUDABLE', style: TextStyle(color: AppColors.greenColor, fontSize: 11, fontWeight: FontWeight.bold, letterSpacing: 1)),
            const SizedBox(height: 2),
            const Row(
              children: [
                Text('NUTRICIÓN ', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w900, color: Colors.white)),
                Text('FITNESS', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w900, color: AppColors.greenColor)),
              ],
            ),
                    ...
                    Builder(builder: (ctx) {
                        return ElevatedButton.icon(
                          onPressed: () {
                            ...
                            // Ahora usamos context.read para enviar la orden sin escuchar reconstrucciones
                            context.read<CartModel>().add(CartItem(id: id, title: title, subtitle: subtitle ?? '', price: parsed, imageUrl: imageUrl));
