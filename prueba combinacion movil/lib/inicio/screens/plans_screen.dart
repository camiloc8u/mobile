            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Text(price, style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: AppColors.greenColor)), 
                      const SizedBox(width: 6), 
                      Text(subtitle ?? '/mes', style: const TextStyle(color: Colors.grey))
                    ]
                  ),
                ]
              ),
                  ...
                  child: Row(
                    children: [
                      Container(
                        width: 18,
                        height: 18,
                        decoration: BoxDecoration(color: AppColors.greenColor, borderRadius: BorderRadius.circular(18)),
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start, 
          children: [
            const Text('PLANES Y PRECIOS', style: TextStyle(color: AppColors.greenColor, fontSize: 12, fontWeight: FontWeight.bold)),
